...
def main(t_tot_idx, amp_regime_idx, wd_regime_idx):
    ...
    regime_name = f"{amp_regime['name']}_{wd_regime['name']}_t{t_tot_center:.1f}"
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Run ef X gate optimization')

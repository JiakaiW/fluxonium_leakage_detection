...
if __name__ == '__main__':
    ...
    system = fluxonium_oscillator_system(
        ...
        osc_level = osc_level,
        kappa =kappa,
        products_to_keep=[[ql, ol] for ql in range(qubit_level) for ol in range(osc_level) ],
    ...
    for i in [0,1,2,3,4]:
        result = system.run_mcsolve_on_driving_osc(initial_state = initial_states[i],
                                                   tlist = tlist,
                                                   osc_decay = True,
        ...
        with open(f'../pickles/mcsolve_2.65_g0.13_a0.003_state{i}.pkl', 'wb') as file:

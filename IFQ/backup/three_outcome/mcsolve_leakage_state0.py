...
if __name__ == '__main__':
    ...
    state_0 = qutip.basis(system.hilbertspace.dimension, system.product_to_dressed[(0,0)])

    result = system.run_mcsolve_on_driving_osc(initial_state = system.truncate_function(state_0),
                                                tlist = tlist,
                                                osc_decay = True,
    ...
    with open(f'../pickles/mcsolve_three_outcome_state{0}.pkl', 'wb') as file:

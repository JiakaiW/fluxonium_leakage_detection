...
if __name__ == '__main__':
    ...
    g = 0.17
    w_d = 8.46043705000408
    amp = 0.003

    tot_time =1000
 
    system1  =  FluxoniumOscillatorSystem(
                    EJ = EJ,
                    EC = EC,
                    EL = EL,
                    Er = Er,
    ...
    initial_states  = [
        qutip.basis(max_ql * max_ol, system1.product_to_dressed[(ql,0)]) for ql in [1]
        ]
    ...
    import pickle
    with open('../pickles/EJ3_1_g0.17.pkl', 'wb') as file:
